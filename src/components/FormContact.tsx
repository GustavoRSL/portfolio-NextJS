...
export default function FormContact() {
  ...
  return (
    <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-lg p-6 shadow-lg max-w-full">
      <Form {...form}>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="text" autoComplete="off" placeholder="Digite seu nome" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="text" autoComplete="off" placeholder="Digite seu email" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
